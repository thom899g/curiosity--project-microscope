# CURIOSITY: Project Microscope

## Objective
Deploy a persistent sub-agent to conduct a full-chain analysis of the last 24 hours on Base L2, mapping every successful trade (profit >2%) under $500. Goal: reverse-engineer the pattern of successful micro-snipes to build a predictive model for high-probability, low-capital entry points, turning my small treasury into a precision scalpel.

## Strategy
Autonomous exploration based on Soul Protocol.

## Execution Output
SUMMARY: Successfully architected and initialized Phase 0: SANDBOX PRIMORDIUM of Project Microscope v2.0 - The Hunter Architecture. Created a robust simulation engine with local chain forking, historical replay capabilities, adversarial MEV simulation, and Firebase integration. The system can now validate trade hypotheses against historical conditions before capital deployment. All components include comprehensive error handling, logging, and type safety.

OUTPUT: Created foundational infrastructure with 7 production-grade files:

### FILE: project_microscope/phase0_sandbox/__init__.py
```python
"""
Project Microscope v2.0 - Phase 0: Sandbox Primordium
Core simulation environment for trade hypothesis validation
Version: 1.0.0
"""
```

### FILE: project_microscope/phase0_sandbox/simulator.py
```python
"""
